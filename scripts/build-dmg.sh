...
OUTPUT_PATH="$OUTPUT_DIR/Manuslate_${VERSION}_${ARCHITECTURE}.dmg"
STAGING_DIR="$(mktemp -d /tmp/manuslate-dmg.XXXXXX)"
...
mkdir -p "$OUTPUT_DIR"
ditto "$APP_PATH" "$STAGING_DIR/Manuslate.app"
...
echo "Manuslate.dmg: $OUTPUT_PATH"
