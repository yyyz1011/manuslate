...
FIRST VIEWPORT: At a 1440px desktop window, show a collapsible 286px library, a centered 760px live manuscript, a 40px translucent native window strip above a separate sidebar brand row (62px combined toolbar in the browser preview), and an optional 286px inspector. At narrower desktop window sizes, rails may collapse or overlay before they can crush the reading measure; phone layouts are not a product target.
