...
FIRST VIEWPORT: At a 1440px desktop window, show a collapsible 286px library, a centered 760px live manuscript, a 62px translucent toolbar, and an optional 286px inspector. At narrower desktop window sizes, rails may collapse or overlay before they can crush the reading measure; phone layouts are not a product target.
